...
var RoleWhere = struct {
	...
	RoleID:    whereHelperint64{field: "\"roles\".\"role_id\""},
...
var (
	roleAllColumns            = []string{"role_id", "name", "created_at"}
	roleColumnsWithoutDefault = []string{"name"}
	roleColumnsWithDefault    = []string{"role_id", "created_at"}
...
func (o *Role) Users(mods ...qm.QueryMod) userQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"users\".\"role_id\"=?", o.RoleID),
	)
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, roleID int64, selectCols ...string) (*Role, error) {
	roleObj := &Role{}
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, roleID int64) (bool, error) {
	var exists bool
