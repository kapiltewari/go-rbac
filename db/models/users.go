...
var (
	userAllColumns            = []string{"user_id", "role_id", "first_name", "last_name", "email", "phone", "password", "active", "created_at"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "email", "phone", "password"}
	userColumnsWithDefault    = []string{"user_id", "role_id", "active", "created_at"}
...
func (o *User) SetRole(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Role) error {
	...
	values := []interface{}{related.RoleID, o.UserID}
